...
public class ViewRequestAdministrator extends javax.swing.JFrame {
    ...
    public ViewRequestAdministrator(SchoolHELP sHelpIn, int adminIndexIn) {
        sHelp = sHelpIn;
        adminIndex = adminIndexIn;
        initComponents();
        model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);
        loggedInAdmin = (SchoolAdmin)sHelp.getUserByIndex(adminIndexIn);
        lbSchoolId.setText("School ID:" + loggedInAdmin.getAffiliatedSchoolID());
        addRowToJtable();
    }
    ...
    private void initComponents() {
        ...
        lbWelcome.setText("Viewing Requests Submitted by School");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Type", "Date", "Status", "Desc"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        cbSortOption.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Unsorted", "Status and Date" }));
    ...
    private void btCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelActionPerformed
        SchoolAdminMenu admMenu = new SchoolAdminMenu(sHelp, adminIndex);
    ...
    private void btProceedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProceedActionPerformed
        ...
        if(requestIndex == -1){
            ...
            ViewOffersAdministrator offAdm = new ViewOffersAdministrator(sHelp, adminIndex, sHelp.findRequestIndex(requestId));
            offAdm.setVisible(true);
            dispose();
        }
    ...
    public void addRowToJtable(){
        ...
        if(selectedOption.equalsIgnoreCase("Status and Date")){
            listOfReq = sHelp.viewRequestsAdmin(loggedInAdmin.getAffiliatedSchoolID(), "statusdate");        
        }
        else{
            listOfReq = sHelp.viewRequestsAdmin(loggedInAdmin.getAffiliatedSchoolID(), "unsorted");
        }
        ...
        for(int i =0; i< listOfReq.size(); i++){
            ...
            rowData[2] = listOfReq.get(i).getRequestDate();

            rowData[3] = listOfReq.get(i).getRequestStatus();

            rowData[4] = listOfReq.get(i).getDescription();
